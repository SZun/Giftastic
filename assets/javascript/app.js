$(document).ready(function(){
    ...
    var audio = new Audio(['../images/christmas.mp4','../images/white_christmas.mp4','../images/let_it_snow.mp4','../images/holly_jolly.mp4','../images/navidad.mp4']);
    audio = Math.floor(Math.random() * audio.length) + audio;
